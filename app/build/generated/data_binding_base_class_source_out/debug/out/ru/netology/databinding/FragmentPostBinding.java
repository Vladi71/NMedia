...
public final class FragmentPostBinding implements ViewBinding {
  ...
  private FragmentPostBinding(@NonNull ConstraintLayout rootView, @NonNull TextView authorTv,
  ...
  public static FragmentPostBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPostBinding((ConstraintLayout) rootView, authorTv, avatarV, contentTv,
          imageIV, likeIb, menuIb, publishedBarrier, publishedBarrier2, publishedTv);
    }
